...
#
# Usage:
#   pwsh Testing/tier2/scenario-1-consistency/claude/run.ps1
#   pwsh Testing/tier2/scenario-1-consistency/claude/run.ps1 -Task "my custom task"
#   pwsh Testing/tier2/scenario-1-consistency/claude/run.ps1 -Task "fix bug" -Workflow bugfix
#   pwsh Testing/tier2/scenario-1-consistency/claude/run.ps1 -Task "explore" -Workflow spike -StopAt design
#   pwsh Testing/tier2/scenario-1-consistency/claude/run.ps1 -SkipValidation
[CmdletBinding()]
param(
